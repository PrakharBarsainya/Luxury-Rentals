...
const TopVillas = () => {
  return (
    <section id="topVillas">
      ...
      <p>
        Discover our handpicked collection of exceptional villas, where elegance
        meets comfort. Each property is designed to offer a refined living
        experience, blending premium amenities with stunning locations and
